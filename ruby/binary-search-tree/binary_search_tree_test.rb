...
class BstTest < Minitest::Test
  ...
  def test_slightly_complex_tree # rubocop:disable Metrics/MethodLength
    four = Bst.new 4
    four.insert 2
    four.insert 3
    assert_equal 4, four.data
  ...
  def test_slightly_complex_tree # rubocop:disable Metrics/MethodLength
    ...
    four.insert 3
    four.insert 4
    assert_equal 5, four.data
    assert_equal 2, four.left.data
    assert_equal 3, four.left.right.data
    assert_equal 4, four.left.right.right.data
  end

  def test_slightly_complex_tree_on_the_right_side # rubocop:disable Metrics/MethodLength
    four = Bst.new 4
    four.insert 6
    four.insert 5
    assert_equal 4, four.data
